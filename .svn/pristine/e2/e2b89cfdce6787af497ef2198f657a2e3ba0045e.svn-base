...
<template>
    <section>
                ...
                <el-form-item style="float:right;marginRight:0;">
                    <Dropdown trigger="custom" :visible="selectColVisible" @on-click="handleSelectCols" class="selectcol">
                        ...
                        <DropdownMenu slot="list">
                            <DropdownItem name="shopname"><Checkbox v-model="checked.shopname"/>车间名称</DropdownItem>
                            <DropdownItem name="employeename"><Checkbox v-model="checked.employeename"/>车间负责人</DropdownItem>
                            <DropdownItem name="shoplocation"><Checkbox v-model="checked.shoplocation"/>车间位置</DropdownItem>
                            <DropdownItem name="shopuse"><Checkbox v-model="checked.shopuse"/>车间主要用途</DropdownItem>
        ...
        <el-table :max-height="windowOutHeight-260" border :data="listData" highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
            ...
            <el-table-column prop="shopname" label="车间名称"  align="center" v-if="isarray('shopname',curTableData)">
            </el-table-column>
            <el-table-column prop="employeename" label="车间负责人" align="center" v-if="isarray('employeename',curTableData)">
            </el-table-column>
            <el-table-column prop="shoplocation" label="车间位置" align="center" v-if="isarray('shoplocation',curTableData)">
            </el-table-column>
            <el-table-column prop="shopuse" label="车间主要用途" align="center" v-if="isarray('shopuse',curTableData)">
            </el-table-column>
            <el-table-column prop="isenable" label="是否启用" :formatter="enableFormat" align="center" v-if="isarray('shopuse',curTableData)">
            </el-table-column>
            <el-table-column fixed="right" label="操作" align="center" width="120">
                <template slot-scope="scope">
                    <Button type="primary" shape="circle" size="small" @click="handleOpen(scope.$index, scope.row)" title="启用" :disabled="scope.row.isdelete == '1' ? true : false">
                    <Icon type="checkmark" :style="scope.row.isenable == '1' ? 'color:red;' : ''"></Icon>
                    </Button>
                        ...
                        <el-col :span="24">
                                <el-form-item label="" prop="shopname">
                                    <el-input v-model="editForm.shopname" auto-complete="off">
                                        <template slot="prepend">车间名称</template>
                                    </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="车间负责人" prop="employeename">
                            ...
                            <el-col :span="24">
                                <el-form-item label="" prop="shoplocation">
                                    <el-input v-model="editForm.shoplocation" auto-complete="off">
                                        <template slot="prepend">车间位置</template>
                                    </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="车间主要用途" prop="shopuse">
...
<script>
    ...
    import {getFarmList,addFarm,modifyFarm,removeFarm,getEmpList} from '../../../api/api';
    export default {
