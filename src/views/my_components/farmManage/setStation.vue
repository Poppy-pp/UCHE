...
<template>
    <section>
                ...
                <el-form-item style="float:right;marginRight:0;">
                    <Dropdown trigger="custom" :visible="selectColVisible" @on-click="handleSelectCols" class="selectcol">
                        ...
                        <DropdownMenu slot="list">
                            <DropdownItem name="shopname"><Checkbox v-model="checked.shopname"/>工位名称</DropdownItem>
                            <DropdownItem name="employeename"><Checkbox v-model="checked.employeename"/>工位负责人</DropdownItem>
                            <DropdownItem name="shoplocation"><Checkbox v-model="checked.shoplocation"/>所属车间</DropdownItem>
                            <DropdownItem name="shoplocation"><Checkbox v-model="checked.shoplocation"/>常用班组</DropdownItem>
                            <DropdownItem name="shopuse"><Checkbox v-model="checked.shopuse"/>工位主要用途</DropdownItem>
        ...
        <el-table :max-height="windowOutHeight-260" border :data="listData" highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
            ...
            <el-table-column prop="shopname" label="工位名称"  align="center" v-if="isarray('shopname',curTableData)">
            </el-table-column>
            <el-table-column prop="employeename" label="工位负责人" align="center" v-if="isarray('employeename',curTableData)">
            </el-table-column>
            <el-table-column prop="shoplocation" label="所属车间" align="center" v-if="isarray('shoplocation',curTableData)">
            </el-table-column>
            <el-table-column prop="shoplocation" label="常用班组" align="center" v-if="isarray('shoplocation',curTableData)">
            </el-table-column>
            <el-table-column prop="shopuse" label="工位主要用途" align="center" v-if="isarray('shopuse',curTableData)">
            </el-table-column>
        ...
        <el-dialog title="编辑" :modal-append-to-body="false" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" :rules="editFormRules" ref="editForm">
                        <el-col :span="24">
                            ...
                            <el-col :span="24">
                                <el-form-item label=" 工位负责人" prop="employeename">
                            ...
                            <el-col :span="24">
                                <el-form-item label="" prop="shoplocation">
                                    <el-input v-model="editForm.shoplocation" auto-complete="off">
                                        <template slot="prepend">所属车间</template>
                                    </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="" prop="shoplocation">
                                    <el-input v-model="editForm.shoplocation" auto-complete="off">
                                        <template slot="prepend">常用班组</template>
                                    </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="工位主要用途" prop="shopuse">
        ...
        <el-dialog title="新增" :modal-append-to-body="false" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" :rules="addFormRules" ref="addForm">
                        <el-col :span="24">
                            ...
                            <el-col :span="24">
                                <el-form-item label="所属车间" prop="shoplocation">
                                    <el-select style="width:80%;" v-model="addForm.deptname" clearable filterable placeholder="请选择工位所属车间" @visible-change="chooseFarm"
                                        remote 
                                        :remote-method="remoteMethodFarm"
                                        :loading="farmLoading">
                                        <el-option
                            ...
                            <el-col :span="24">
                                <el-form-item label="常用班组" prop="shoplocation">
                                    <el-select style="width:80%;" v-model="addForm.deptname" clearable filterable placeholder="请选择工位常用班组" @visible-change="chooseTeamwork"
                                        remote 
                                        :remote-method="remoteMethodTeamwork"
                                        :loading="teamworkLoading">
                                        <el-option
